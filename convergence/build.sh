#!/usr/bin/env bash
# Build convergence/paper.pdf from convergence/paper.md.
#
...
pandoc paper.md \
  ...
  --toc \
  --toc-depth=2 \
  --metadata title='Capacity-Allocation Predicts a Coordination Ceiling at k ≈ 7 ± 2' \
  --metadata author='Riley Rook' \
  --metadata date='2026-05-16'

echo "[convergence] paper.pdf written"
